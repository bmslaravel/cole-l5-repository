 ...
 */
class ViewCreateGenerator extends Generator
{
    ...
    {
        return $this->getBasePath() . '/' . $this->getPluralName() . '/' . 'create.blade.php';
    }
    ...
    {
        return base_path('resources/views/admins');
    }
    ...
    public function getReplacements()
    {
        ...
        return array_merge(parent::getReplacements(), [
            ...
            'mkdirUc'      => ucfirst($this->getSingularName()),
            'mkdirs'      => $this->getPluralName(),
            'mkdirsUc'      => ucfirst($this->getPluralName()),
        ]);
    }
